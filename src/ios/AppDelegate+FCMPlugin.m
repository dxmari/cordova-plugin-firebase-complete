...
- (void)userNotificationCenter:(UNUserNotificationCenter *)center
    ...
    NSData *jsonData = [NSJSONSerialization dataWithJSONObject:userInfoMutable
                                                       options:0
                                                         error:&error];
    [FirebaseComplete.firebaseComplete notifyOfMessage:jsonData];
...
- (void)tokenRefreshNotification:(NSNotification *)notification
{
    ...
    [FirebaseComplete.firebaseComplete notifyOfTokenRefresh:refreshedToken];
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    [FirebaseComplete.firebaseComplete  appEnterForeground];
    [self connectToFcm];
}
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    [[FIRMessaging messaging] disconnect];
    [FirebaseComplete.firebaseComplete  appEnterBackground];
